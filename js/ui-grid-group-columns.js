...
angular.module('app').service('uiGridGroupColumnsService', [
  '$log',
  '$q',
  '$compile',
  'gridUtil',
  class {
    ...
    defaultGridOptions(grid) {
      ...
      if (grid.options.headerTemplate !== null) {
        ...
        grid.options.headerTemplate = 'ui-grid-header-group-columns.html'; // eslint-disable-line no-param-reassign
      }
      ...
      if (grid.options.rowTemplate !== 'ui-grid/ui-grid-row') {
        ...
        grid.options.rowTemplate = 'ui-grid-row-group-columns.html'; // eslint-disable-line no-param-reassign
      }
      ...
      if (grid.options.footerTemplate !== 'ui-grid/ui-grid-footer') {
        ...
        grid.options.footerTemplate = 'ui-grid-footer-group-columns.html'; // eslint-disable-line no-param-reassign
      }
    }
...
angular.module('app').directive('uiGridGroupColumns', [
