...
var PageView = function pageView(container, id, scale, defaultViewport,
  ...
  this.draw = function pageviewDraw(callback) {
    ...
    if (!pdfPage) {
      ...
      //parent.load_previous_page(window.frameElement.id)
      return;
    }
...
window.addEventListener('mouseup', function(e){
	...
	var bbox_val = range.getBoundingClientRect();
	var txt = range.toString();
	//console.log(bbox_val, txt);
	//parent.selected_area_values(bbox_val, txt);		
});
