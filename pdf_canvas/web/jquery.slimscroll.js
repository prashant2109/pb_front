        ...
        function scrollContent(x, y, isWheel, isJump)
        {
          ...
          if(hasHorizontalScrollbar){
            ...
            if (isWheel)
            {
              ...
              deltaX = parseInt(barX.css('left')) + moveFactor * parseInt(o.wheelStep) / 100 * barX.outerHeight();
              ...
              /*var speedfix  = 10;
              deltaX = (moveFactor > 0) ? Math.ceil(deltaX) + speedfix  : Math.floor(deltaX)- speedfix;*/
	      ...
	      //var speedfix  = 0;
              //deltaY = (y > 0) ? Math.ceil(deltaY) + speedfix  : Math.floor(deltaY)- speedfix;
              // scroll the scrollbar
              /*if (deltaY < 0){
	             deltaY=1;
              }
	      var tmp_asn = (deltaY+barY.outerHeight());
              if(tmp_asn < deltaY){
		     deltaY = railY.outerHeight()-deltaY;
	      }*/
